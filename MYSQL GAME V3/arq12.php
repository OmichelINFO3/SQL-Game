...
<body>
	...
	<div id="questoes">
		<h2>Questão 10<h2>
		<h3>Os joins são usados para realizar a fusão entre tabelas, permitindo uma pesquisa relacional entre as duas tabelas, os joins podem ser: middle, left, right, cross</h3><br><br>
		<h4>Qual tipo de join não é verdadeiro dentre os citados?</h4><br><br>
	</div>
	<div id="form">
