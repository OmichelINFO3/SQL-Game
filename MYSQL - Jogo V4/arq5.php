...
<body>
	...
	<div id="questoes">
		<h2>Questão 3<h2>
		<h3>Insira na tabela usuario, que possui os atributos 'id', 'nome' e 'idade' um registro com os valores '3','Felipe' e '28'</h3><br>
		<h4></h4>
	</div>
	<div id="form">
...
$resposta_correta = str_replace(' ', '', strtolower("insert into usuario values(3,'Felipe',28)"));
