...
<body>
	...
	<div id="questoes">
		<h2>Questão 6<h2>
		<h3>Houve um erro na inserção dos dados na tabela cidade, a cidade de livramento foi determinada como sendo do estado 'RJ', com um update, corriga o estado da cidade de livramento.</h3><br><br>
		<h4>Atributos da tabela cidade: id, nome, estado</h4>
	</div>
	<div id="form">
...
if (mysqli_connect_errno()) {
 ...
 exit();
    ...
    $resposta_correta = str_replace(' ', '', strtolower("update cidade set estado='rs' where cidade='livramento'"));
